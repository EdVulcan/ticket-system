...
- 酒店住宿当前只建立平台可配置、登录可识别和服务端可鉴权的业态基础。尚未建设房型、房态、入住、夜审等酒店业务，不显示空模块，也不得宣称酒店闭环已完成。
