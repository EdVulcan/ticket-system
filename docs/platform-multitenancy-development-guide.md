...
> **当前 schema 复核（2026-08-19）**：当前总 schema 为 104。除前述酒店和 Agent 事实外，打印模板/版本/打印任务快照及竖横版方向已纳入迁移、租户景区归属触发器和自动化测试；历史段落中的旧 schema 数字仅描述当时状态。
