...
- schema 81 已建立酒店、房型、价格计划和按入住日管理的共享房量；预留、已售和关闭销售状态与门票库存分离。单酒店在线预订、入住/离店、夜审和独立酒店结算仍未建设，不得宣称酒店业务已形成完整 PMS 闭环。
