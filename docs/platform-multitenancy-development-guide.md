...
状态：独立渠道账号、密钥轮换、商品映射、正文签名、请求正文冲突检测、请求失败授权重试、渠道订单综合查询、账单导入及逐笔差异下钻已落地；携程供应商预下单、支付同步确认、预下单取消、未核销整单取消和订单查询已完成首批协议代码，等待沙箱遍历并确认部分退订、仅退款和核销通知范围。美团仍待协议与凭据。智游宝上游供应接入不在当前阶段。
