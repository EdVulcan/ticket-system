export const tenantRoleOptions = [
  ...
  { value: 'team_operator', label: '团队业务员', description: '处理合作申请、团队、名单和现场确认，不可修改合同价格与授信' },
  { value: 'settlement_operator', label: '结算对账员', description: '处理上下游对账、结算、退款待办，并维护团队合同价格与授信' },
