...
type DistributorRelationship struct {
	...
	DistributionAppliedAt *time.Time `json:"distribution_applied_at,omitempty"`             // 分销合作最近申请时间
	TravelAppliedAt       *time.Time `json:"travel_applied_at,omitempty"`                   // 团队合作最近申请时间
