...
type Tenant struct {
	...
	SupplierBusinessTypes  []SupplierBusinessType     `json:"supplier_business_types,omitempty"`
	BusinessCapabilities   []TenantBusinessCapability `json:"business_capabilities,omitempty"`
}
