...
type HotelReservation struct {
	...
	Status               string    `gorm:"size:20;not null;default:'reserved';index;check:chk_hotel_reservations_status,status IN ('reserved','confirmed','cancelled','refunded')" json:"status"`
}
