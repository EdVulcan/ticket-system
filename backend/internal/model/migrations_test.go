...
func TestMigrationsReachCurrentVersionAndAreIdempotent(t *testing.T) {
	...
	if latest.Version != 64 {
		t.Fatalf("latest migration=%d, want 64", latest.Version)
	}
