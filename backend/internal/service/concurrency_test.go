...
func resetBusinessData(t *testing.T) {
	...
	err := model.Write(func(tx *gorm.DB) error {
		for _, table := range []interface{}{
			...
			&model.XiaohongshuOrderOperation{}, &model.XiaohongshuBookingOperation{}, &model.ScenicHotelPackageEntitlement{}, &model.HotelReservation{}, &model.ScenicHotelPackage{}, &model.HotelRatePlanPrice{}, &model.HotelRoomInventory{}, &model.HotelRatePlan{}, &model.HotelRoomType{}, &model.HotelProperty{},
