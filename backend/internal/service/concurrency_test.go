...
func resetBusinessData(t *testing.T) {
	...
	err := model.Write(func(tx *gorm.DB) error {
		for _, table := range []interface{}{
			...
			&model.CtripOutboundTask{}, &model.CtripOrderItem{}, &model.CtripOrderLink{}, &model.XiaohongshuWebhookEvent{}, &model.MiniappCustomer{}, &model.ChannelAccount{}, &model.ChannelProductMapping{}, &model.ChannelRequest{}, &model.ChannelReservation{}, &model.TourGroupConfirmation{}, &model.TourGroupMemberChange{}, &model.TourGroupMember{}, &model.TourEntryBatch{}, &model.TourGroup{}, &model.TravelContract{}, &model.TravelAgent{}, &model.TourGuide{}, &model.TravelVehicle{}, &model.POSShiftCorrection{}, &model.POSShift{}, &model.PrintJob{}, &model.DeviceAlert{}, &model.POSHold{},
