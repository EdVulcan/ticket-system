...
func resetBusinessData(t *testing.T) {
	...
	err := model.Write(func(tx *gorm.DB) error {
		for _, table := range []interface{}{
			...
			&model.AfterSaleEvent{}, &model.AfterSaleRequest{}, &model.HardwareEvent{}, &model.HardwareCommand{}, &model.DeviceRequestNonce{}, &model.DeviceVerification{}, &model.MobileVerificationSession{}, &model.DeviceMaintenanceSession{}, &model.DeviceMaintenanceCredential{}, &model.DeviceProvisioningLease{}, &model.FinancialDocument{}, &model.TeamSettlementAdjustment{}, &model.TeamSettlementStatement{},
