...
func resetBusinessData(t *testing.T) {
	...
	err := model.Write(func(tx *gorm.DB) error {
		for _, table := range []interface{}{
			&model.CommerceShipmentEvent{}, &model.CommerceAssistRecord{}, &model.CommerceAssistSession{}, &model.CommerceShipment{}, &model.CommerceOrderAdjustment{}, &model.CommerceCheckoutQuote{}, &model.CommerceAssistCampaign{}, &model.CommerceCouponGrant{}, &model.CommerceCouponTemplate{}, &model.CommerceDeliverySlot{}, &model.CommerceDeliveryZone{}, &model.CommerceLocationServiceConfig{},
			&model.CommercePaymentProviderEvent{}, &model.CommerceRefundAttempt{}, &model.CommercePaymentAttempt{}, &model.CommerceAfterSaleEvent{}, &model.CommerceOrderPaidOutbox{}, &model.CommerceMerchantNotification{}, &model.CommerceOrderItem{}, &model.RestaurantFulfillment{}, &model.RetailFulfillment{}, &model.CommercePaymentReconciliationTask{}, &model.CommerceAfterSaleRequest{}, &model.CommerceCartItem{}, &model.CommerceCart{}, &model.CommerceInventory{}, &model.CommerceOption{}, &model.CommerceOptionGroup{}, &model.CommerceSKU{}, &model.CommerceProductMedia{}, &model.CommerceOrder{}, &model.CommerceProduct{}, &model.CommerceAddress{}, &model.CommerceCustomerSession{}, &model.CommerceStorefrontBinding{}, &model.CommerceFulfillmentLocation{},
			...
			&model.XiaohongshuVoucherVerification{}, &model.XiaohongshuVoucherLink{}, &model.XiaohongshuOrderLink{}, &model.XiaohongshuProductConfig{}, &model.CtripOutboundTask{}, &model.CtripOrderItem{}, &model.CtripOrderLink{}, &model.XiaohongshuWebhookEvent{}, &model.XiaohongshuRefundCoordination{}, &model.MiniappCustomer{}, &model.ChannelProductMapping{}, &model.ChannelAccount{}, &model.ChannelRequest{}, &model.ChannelReservation{}, &model.TourGroupConfirmation{}, &model.TourGroupMemberChange{}, &model.TourGroupMember{}, &model.TourEntryBatch{}, &model.TourGroup{}, &model.TravelContract{}, &model.TravelAgent{}, &model.TourGuide{}, &model.TravelVehicle{}, &model.POSShiftCorrection{}, &model.POSShift{}, &model.PrintJob{}, &model.PrintTemplateRevision{}, &model.PrintTemplate{}, &model.DeviceAlert{}, &model.POSHold{},
			&model.AfterSaleEvent{}, &model.AfterSaleRequest{}, &model.HardwareEvent{}, &model.HardwareCommand{}, &model.DeviceRequestNonce{}, &model.DeviceVerification{}, &model.MobileVerificationOperation{}, &model.MobileVerificationPreview{}, &model.MobileVerificationSession{}, &model.DeviceMaintenanceSession{}, &model.DeviceMaintenanceCredential{}, &model.DeviceProvisioningLease{}, &model.FinancialDocument{}, &model.TeamSettlementAdjustment{}, &model.TeamSettlementStatement{},
